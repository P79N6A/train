package com.petzm.training.module.player.view.interfaces;
...
/**
 * 定义UI界面通用的操作。
 * 主要实现类有{@link com.petzm.training.module.player.view.control.ControlView} ,
 * {@link com.petzm.training.module.player.view.gesture.GestureView}
 */
