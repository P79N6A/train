...
import com.petzm.training.network.response.AddGoods;
import com.petzm.training.network.response.AddGoodsItem;
import com.petzm.training.network.response.AddGoodsObj;
import com.petzm.training.network.response.BillObj;
import com.petzm.training.network.response.GradObj;
import com.petzm.training.network.response.HomeBannerObj;
import com.petzm.training.network.response.LoginObj;
import com.petzm.training.network.response.MoneyDetailObj;
import com.petzm.training.network.response.OrderDetailObj;
import com.petzm.training.network.response.OrderListObj;
import com.petzm.training.network.response.RegisterObj;
import com.petzm.training.network.response.WalletObj;
import com.petzm.training.network.response.WithdrawalsObj;
