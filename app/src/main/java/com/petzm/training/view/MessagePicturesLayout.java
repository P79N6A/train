...
//
//        if(urlListSize == 4){
//             imageSize = (int) ((getWidth() * 1f - mSpace * (3 - 1)) / 3);
//        }else{
//             imageSize = urlListSize == 1 ? mSingleMaxSize :
...
//                iPicture.setBackgroundResource(R.drawable.default_pic);
...
//        if (mCallback != null) {
//            mCallback.onThumbPictureClick((ImageView) v, position, mVisiblePictureList, mDataList);
//        }
//    }
//
//    public interface Callback {
//        void onThumbPictureClick(ImageView i, int position, SparseArray<ImageView> imageGroupList, List<Uri> urlList);
//    }
//
