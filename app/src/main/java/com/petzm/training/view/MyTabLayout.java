        ...
        this.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(Tab tab) {
                ...
                if (tab != null && tab.getCustomView() != null) {
                    ...
                    tab_text.setTextColor(getResources().getColor(R.color.circle_tablayout_select_color));
//                    tab_text.setBackgroundResource(R.drawable.tablayout_item_pressed);
            ...
            public void onTabUnselected(Tab tab) {
                ...
                if (tab != null && tab.getCustomView() != null) {
                    ...
                    tab_text.setTextColor(getResources().getColor(R.color.circle_tablayout_unselect_color));
                    TextPaint paint = tab_text.getPaint();
