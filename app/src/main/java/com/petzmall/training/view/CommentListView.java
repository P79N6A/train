...
import com.petzmall.training.MyApplication;
import com.petzmall.training.R;
import com.petzmall.training.module.socialCircle.bean.CommentsReply;
import com.petzmall.training.tools.Utils;
import com.petzmall.training.view.spannable.CircleMovementMethod;
...
public class CommentListView extends LinearLayout {
    ...
    private List<CommentsReply> mDatas;
    ...
    public void setDatas(List<CommentsReply> datas){
        if(datas == null ){
            datas = new ArrayList<CommentsReply>();
        }
        mDatas = datas;
        notifyDataSetChanged();
    }

    public List<CommentsReply> getDatas(){
        return mDatas;
    }
    ...
    private View getView(final int position){
        ...
        final CommentsReply bean = mDatas.get(position);
        String name = bean.getFromUname();
...
//        }
        ...
        builder.append(setClickableSpan(name, bean.getId()+""));
...
//        }
        ...
        builder.append(Utils.formatUrlString(contentBodyStr));
