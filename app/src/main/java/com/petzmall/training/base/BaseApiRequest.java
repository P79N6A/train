...
import com.petzmall.training.NetWorkManager;
...
public class BaseApiRequest{
    ...
    //返回对象
    protected static <T> T getCommonWithCacheClient(Class<T>clazz){
        return NetWorkManager.getCommonWithCacheClient().create(clazz);
    }
